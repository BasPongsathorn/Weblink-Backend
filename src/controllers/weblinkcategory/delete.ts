...
const deleteWeblinkCategory = async( req:Request , res:Response) => {
...
const deleteAllWeblinkcategory = async( req:Request , res:Response) => {
    const deleteallwebcate = await prisma.weblinkCategories.deleteMany();
    return res.json(deleteallwebcate);
    
}

export { deleteAllWeblinkcategory , deleteWeblinkCategory }